...
From the **open workspace** (Pattern A — one script command). Defaults: **`with_mcp`**, **`.venv`**, **verify gates** — full consumer kit (8 agents, 16 skills, MCP, PR scripts, `.local/` scaffold, runtime `.gitignore`, `STARTER-001`).
