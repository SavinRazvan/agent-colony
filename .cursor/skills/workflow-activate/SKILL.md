...
From the **open workspace** (Pattern A — one script command). Defaults: **`with_mcp`**, **`.venv`**, **verify gates** — full consumer kit (**9 agents**, **27 skills**, MCP, PR scripts, `.local/` scaffold, runtime `.gitignore`, `STARTER-001`).
