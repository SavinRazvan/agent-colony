<!--
File: README.md
Path: project-rules/README.md
Role: Deprecated alias — use overlays/rules/ for product rule sources.
Used By:
 - Legacy install docs (redirect only)
Depends On:
 - overlays/README.md
Notes:
 - Do not add new rules here; canonical overlay home is overlays/rules/.
-->
