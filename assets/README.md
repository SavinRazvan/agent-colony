...
Marketplace logotype and docs screenshots for **Agent Colony** (`agent-colony`).
...
`agent-colony-install.png` — Agent chat with `/add-plugin` and the **Agent Colony** preview card. Linked from root `README.md` § Install step 1.
