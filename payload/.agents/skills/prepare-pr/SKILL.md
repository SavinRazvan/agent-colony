...
2. Alignment files present when required (authored via **`auditor`** / `auditor-protocol` skill; see `advisory-audit-alignment-enforcement.mdc`); no open **P0** unless explicitly accepted.
