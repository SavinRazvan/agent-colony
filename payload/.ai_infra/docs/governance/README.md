...
| [rules-overlap-matrix.md](rules-overlap-matrix.md) | Cursor rules inventory (7 rules: 4 always-on + 3 requestable) |
...
| Architecture-impacting audits | `auditor` + [auditor-protocol/SKILL.md](../../../.cursor/skills/auditor-protocol/SKILL.md) |
