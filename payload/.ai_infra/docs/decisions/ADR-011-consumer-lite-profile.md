...
Fixed Cursor overhead per turn includes always-applied rules (~10 KB at full tier), `AGENTS.md` (~6.5 KB), skill catalog, and MCP tool schemas. Full kit ships **27** canonical skills (11 `debug-*` + 16 core/protocol skills), 7 rules (4 always-on + 3 requestable after kit 0.7.0), and **9** agents — more than day-to-day consumer implement/verify loops need.
