...
| | |
|--|--|
| **Version** | [`0.6.3`](https://github.com/SavinRazvan/agent-colony/releases) · **Tests** · 1502 · **Agents** · 8 · **Skills** · 14 · **Rules** · **7 universal** · **License** · [Apache-2.0](LICENSE) |
...
**Proof:** 1502 tests · 8 agents · reference layout on [Playground #3](https://github.com/users/SavinRazvan/projects/3).
