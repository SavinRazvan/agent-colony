...
| Root | Role |
|------|------|
| `.cursor/agents/` | 9 agent cards — `auditor`, `board`, `debugger`, `drift-guard`, `implementer`, `integrator`, `researcher`, `test-runner`, `verifier` |
| `.cursor/skills/` | 27 canonical protocols — see [repository-map](.ai_infra/docs/handoff/repository-map.md) |
