...
const FOLLOWUP_SLICES = [
  ...
  },
  {
    ...
    items: [
      ...
      "1143 tests collected; COV-100 6503 stmts / 100%; drift validate green",
    ],
  },
  {
    id: "doc-drift",
    ...
    <Stack gap={24} style={{ padding: 24, maxWidth: 960 }}>
      <Stack gap={8}>
        ...
        <Text tone="secondary">
          ...
          and expanded tests (1143 collected) are shipped on main.
        </Text>
      </Stack>
        ...
        <Card>
          ...
          <CardBody>
            <Stack gap={4}>
              ...
              <Text size="small">
                1143 tests collected; COV-100 6503 stmts / 100%; DRIFT validate
                P0=0 P1=0 P2=0
              </Text>
      ...
      <Text size="small" tone="tertiary">
        ...
        drift validate green · verified {VERIFIED} · 1143 tests · COV-100 6503 stmts
      </Text>
    </Stack>
  );
}
