...
const GOALS = [
  ...
  "DRIFT-001…017 script-first; goal pulse prose in drift artifacts",
...
const READ_FIRST = [
  ...
  ["DRIFT-009 / 010 / 011 / 012", "Board subset of DRIFT-001…017 (roster + plan snapshots)"],
  ...
  return (
    <Stack gap={20} style={{ padding: 20, maxWidth: 980 }}>
      ...
      <Grid columns={3} gap={12}>
        ...
        <Stat value="DRIFT-009…012" label="Board subset (DRIFT-001…017)" />
