 ...
 *  - CLI/MCP stack (renames v0.6.0/v0.6.1; current kit 0.6.3): agent_colony / agent-colony console;
    ...
    <Stack gap={20} style={{ padding: 20, maxWidth: 1140 }}>
      ...
      {view === "stack" ? (
        <Stack gap={12}>
          ...
          <Callout tone="neutral" title="CLI / MCP stack (kit 0.6.3)">
            Renames landed in v0.6.0 (CLI) / v0.6.1 (MCP). Current kit 0.6.3:
