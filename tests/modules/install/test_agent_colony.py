"""
File: test_agent_colony.py
Path: tests/modules/install/test_agent_colony.py
Role: Tests for agent_colony CLI.
Used By:
 - pytest
Depends On:
 - agent_colony/cli.py
...
def test_gates_invokes_five_steps(monkeypatch: pytest.MonkeyPatch) -> None:
    from agent_colony.cli import cmd_gates, kit_root
...
def test_version_in_package() -> None:
    ...
    assert agent_colony.__version__ == "0.6.6"
