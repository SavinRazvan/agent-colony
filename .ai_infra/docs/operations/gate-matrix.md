...
| **MCP audit / merge check** | Agent Pattern A | `workflow_check_audit_artifacts`; `workflow_run_merge_check` appends `--arch-impacting` from pipeline (28 kit tools) | `agent_colony_mcp/server.py` |
