...
|---------|-----------------|
| `prepare.py` GATES | **No** — universal 2-gate consumer contract |
...
| Agent Anchor/MCP, registry parity | `integrate validate` INT-001…013 (incl. INT-011 drift-guard file, INT-012 drift P0 parity, INT-013 doc facts) |
