...
**Last updated:** 2026-07-21 (set-section + Acceptance/Rollback handoff gate; 1178 tests)
**Product:** `mas-workflow-kit-project-ssot` · CLI: `cursor-workflow` 0.4.0 · **Tests:** 1178
...
| Tests | 1178 collected (1166 passed + 2 skipped on full green run; intentional live-smoke skips) | `tests/modules/` |
...
(COV-100 closure): **7089 statements, 100.00%** on a full suite pass (**1178
