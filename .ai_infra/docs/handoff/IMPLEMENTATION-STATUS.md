...
**Last updated:** 2026-07-01 (consumer onboarding docs + integrate validate consumer skip)  
**Product:** MAS Workflow Kit (`mas-workflow-kit`) · CLI: `cursor-workflow` 0.3.0 · **Tests:** 124
