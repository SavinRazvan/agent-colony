...
2. `make install-dry-run` — consumer install green (`check_consumer_purity.py` + scaffold verify); consumer profile includes **DRIFT-013** (tracked runtime paths)
...
**Current release:** `0.8.0` (git tag [`v0.8.0`](https://github.com/SavinRazvan/agent-colony/releases/tag/v0.8.0) when published).
...
**Listing copy refresh (2026-08-23 ICC dashboard removal):** Deprecated ICC HTML / `.local/agents-control-center/` removed; activate/update deletes leftovers; module-audit → `workflow-artifacts/audit/`; **1544** tests at that date; **8** / **15** / **7** (lite: **6** / **6**); kit **0.7.3** — test count **superseded** by 2026-09-14 (**1652**).
