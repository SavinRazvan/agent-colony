...
**Listing copy refresh (2026-08-05 audit #178 alignment):** Re-verified against `IMPLEMENTATION-STATUS.md` + filesystem — **1415** tests; agent/skill/rule counts (**8** / **13** / **7**) canonical `.cursor/skills` (+6 maintainer slash skills under `.agents/skills`); kit version **0.4.0**. Description row updated to **8 / 13 / 7**.
