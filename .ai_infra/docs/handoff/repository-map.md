...
├── tests/                      Kit-dev only — full pytest suite (1502; see IMPLEMENTATION-STATUS)
...
**Not installed:** kit `tests/modules/` (1502; see IMPLEMENTATION-STATUS), `Makefile`, `docs/handoff/`, `docs/maintainer/`, `.ai_infra/scripts/ci/`, `.ai_infra/scripts/release/`, this `repository-map.md`, `IMPLEMENTATION-STATUS.md`, repo-root `agents/rules/skills/`.
